"""
Round 5 v29 — push target_pos magnitudes further to 9 (vs v28 8) for more aggressive trend exposure.
...
MR_CAP = 7          # max |mr_adj| in position units (don't flip base direction)
...
CFG: dict[str, dict] = {
    ...
    "TRANSLATOR_ECLIPSE_CHARCOAL": {"size": 6, "min_half": 2, "inv_skew": 4, "target_pos": +9},
    # v11: target_pos=+5 (was 0). D5 mid drift +352 ticks; ride the uptrend.
    "TRANSLATOR_ASTRO_BLACK":      {"size": 6, "min_half": 2, "inv_skew": 4, "target_pos": +9},
    # v10: target_pos=-5 (was 0). D5 mid dropped 524 ticks; ride the trend.
    "ROBOT_LAUNDRY":               {"size": 6, "min_half": 2, "inv_skew": 4, "target_pos": -9},
    ...
    "PANEL_1X2":                   {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": -9},
    "UV_VISOR_AMBER":              {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": -9},
    "PEBBLES_M":                   {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "SLEEP_POD_SUEDE":             {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},
    "MICROCHIP_RECTANGLE":         {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "GALAXY_SOUNDS_SOLAR_FLAMES":  {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},
    "TRANSLATOR_GRAPHITE_MIST":    {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +9},
    ...
    "PANEL_4X4":                   {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +9},
    "PEBBLES_XL":                  {"size": 4, "min_half": 4, "inv_skew": 15, "target_pos": +9},
    "GALAXY_SOUNDS_DARK_MATTER":   {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "PANEL_2X2":                   {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": -9},
    "ROBOT_IRONING":               {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},
    # v9: target_pos=+5 (REVERSE the losing direction — ride the uptrend).
    "ROBOT_VACUUMING":             {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +9},
    ...
    "UV_VISOR_RED":                  {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +9},
    "UV_VISOR_ORANGE":               {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +9},
    ...
    "GALAXY_SOUNDS_PLANETARY_RINGS": {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    # v16: tier-1 upgrade. Drift -398 was under-captured at tier-2 sizing.
    "PANEL_1X4":                     {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": -9},
    ...
    "SLEEP_POD_COTTON":              {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},
    "PEBBLES_S":                     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "MICROCHIP_OVAL":                {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},

    # ----- v13 ADDITIONS — 4 more trending non-CFG products -----
    "UV_VISOR_MAGENTA":              {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "PANEL_2X4":                     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "ROBOT_MOPPING":                 {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "MICROCHIP_TRIANGLE":            {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},

    # ----- v14 ADDITIONS — 6 more trending non-CFG products -----
    "TRANSLATOR_SPACE_GRAY":         {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "SLEEP_POD_LAMB_WOOL":           {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "MICROCHIP_SQUARE":              {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "OXYGEN_SHAKE_GARLIC":           {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},
    "OXYGEN_SHAKE_MINT":             {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "OXYGEN_SHAKE_MORNING_BREATH":   {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},

    # ----- v15 ADDITIONS — small-drift sweep -----
    "PEBBLES_XS":                    {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "TRANSLATOR_VOID_BLUE":          {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},
    "SLEEP_POD_NYLON":               {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},
    "MICROCHIP_CIRCLE":              {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},

    # ----- v17 ADDITIONS — final low-drift sweep -----
    "SNACKPACK_CHOCOLATE":           {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},
    "OXYGEN_SHAKE_EVENING_BREATH":   {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "SLEEP_POD_POLYESTER":           {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +9},
    "GALAXY_SOUNDS_BLACK_HOLES":     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},

    # ----- v18 ADDITIONS — smallest-drift sweep -----
    "PEBBLES_L":                     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "SNACKPACK_VANILLA":             {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
    "GALAXY_SOUNDS_SOLAR_WINDS":     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -9},
}
...
class Trader:
    ...
    def run(self, state: TradingState) -> tuple[dict[str, list[Order]], int, str]:
        ...
        new_trader_data = json.dumps(
            {"ewma": ewma_state, "pairs": pair_state, "tick": tick_count},
            separators=(",", ":"),
        )
