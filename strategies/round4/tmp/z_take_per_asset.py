"""
Round 4 — z_take_per_asset: per-asset (z_thresh, take_size) tuned variant
of z_take.py.

Same logic as z_take.py — pure z-score market-taker off a STATIC mean per
product. The only difference is that z_thresh and take_size were swept
in-sample over all 4 observed days (round3 d0 + round4 d1-3) and chosen
per-product to maximize per-day mean + per-day min.

In-sample portfolio m+m: 434k → 496k (+14% vs uniform z=1.0, t=17).

OVERFIT WARNING — these values are fitted to the same 4 days the
mean/sd were derived from. Only deploy after MC perturbation confirms
robustness. See mc_z_take_per_asset_overfit.py.
"""
...
# excluded.
CFGS = [
    {"symbol": "HYDROGEL_PACK",       "mean": 9994, "sd": 32.588, "z_thresh": 1.0,  "take_size": 10,  "limit": 200},
    {"symbol": "VELVETFRUIT_EXTRACT", "mean": 5247, "sd": 17.091, "z_thresh": 1.0,  "take_size": 25,  "limit": 200},
    {"symbol": "VEV_4000",            "mean": 1247, "sd": 17.114, "z_thresh": 1.5,  "take_size": 10,  "limit": 300},
    {"symbol": "VEV_4500",            "mean":  747, "sd": 17.105, "z_thresh": 1.5,  "take_size": 10,  "limit": 300},
    ...
    {"symbol": "VEV_5200",            "mean":   91, "sd": 12.796, "z_thresh": 0.5,  "take_size": 10,  "limit": 300},
    {"symbol": "VEV_5300",            "mean":   43, "sd":  8.976, "z_thresh": 1.25, "take_size": 17,  "limit": 300},
    {"symbol": "VEV_5400",            "mean":   14, "sd":  4.608, "z_thresh": 1.0,  "take_size": 10,  "limit": 300},
    {"symbol": "VEV_5500",            "mean":    6, "sd":  2.477, "z_thresh": 0.5,  "take_size": 50,  "limit": 300},
]
