"""
Round 4 v05 — combined: v02 (softer VFRUIT) + v03 (smile arb on active
strikes, layered) + v04 (delta-1 deep ITM).

  HYDROGEL_PACK         → Kalman-MR (unchanged)
  VELVETFRUIT_EXTRACT   → Kalman-MR with mr_gain 1000, take_max_pay -4,
                          quote_size 15  (v02; weak round-4 ADF)
  VEV_4000 / VEV_4500   → fair = max(0, S - K), tight MM         (v04)
  VEV_5000 … VEV_5500   → divergence + smile-arb take overlay    (v03)
"""
