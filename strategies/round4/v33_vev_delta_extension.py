"""Round 4 v33 — v29 + ITM VEV delta extension.
...
VEV_DELTA_VOUCHERS = [
    {"symbol": "VEV_4000", "strike": 4000, "limit": 300, "soft_cap": 250},
    {"symbol": "VEV_4500", "strike": 4500, "limit": 300, "soft_cap": 250},
]
VEV_INTRINSIC_OFFSET = 2     # only take when ask <= intrinsic + offset (cap slippage)
    ...
    if cfg["prefix"] == "vfe" and conviction > 0 and primary_target > primary_taken:
        ...
        for v in VEV_DELTA_VOUCHERS:
            ...
            if direction > 0 and v_pos < v_soft_cap:
                max_pay = intrinsic + VEV_INTRINSIC_OFFSET
                rem = overflow
                ...
                min_recv = intrinsic - VEV_INTRINSIC_OFFSET
                rem = overflow
