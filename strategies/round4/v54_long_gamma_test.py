...
GAMMA_STRIKE = 5300
GAMMA_TARGET_POS = 30        # target long position in calls
GAMMA_BUILD_RATE = 5         # max lots/tick to build position
GAMMA_REBAL_THRESH = 5       # only rebalance VFE if drift > this many lots

# Time to expiry: estimate ~3 days at start of round 4
DAYS_AT_START = 3.0
TRADING_DAYS = 250.0
