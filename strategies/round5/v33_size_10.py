...
CFG: dict[str, dict] = {
    ...
    "TRANSLATOR_ECLIPSE_CHARCOAL": {"size": 10, "min_half": 2, "inv_skew": 4, "target_pos": +10},
    # v11: target_pos=+5 (was 0). D5 mid drift +352 ticks; ride the uptrend.
    "TRANSLATOR_ASTRO_BLACK":      {"size": 10, "min_half": 2, "inv_skew": 4, "target_pos": +10},
    # v10: target_pos=-5 (was 0). D5 mid dropped 524 ticks; ride the trend.
    "ROBOT_LAUNDRY":               {"size": 10, "min_half": 2, "inv_skew": 4, "target_pos": -10},
    "SNACKPACK_PISTACHIO":         {"size": 10, "min_half": 4, "inv_skew": 6, "target_pos":  0},
    ...
    "SNACKPACK_RASPBERRY":         {"size": 10, "min_half": 4, "inv_skew": 6, "target_pos":  0},
    "SNACKPACK_STRAWBERRY":        {"size": 10, "min_half": 4, "inv_skew": 6, "target_pos":  0},
    ...
    "PANEL_1X2":                   {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": -10},
    "UV_VISOR_AMBER":              {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": -10},
    "PEBBLES_M":                   {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "SLEEP_POD_SUEDE":             {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},
    "MICROCHIP_RECTANGLE":         {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "GALAXY_SOUNDS_SOLAR_FLAMES":  {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},
    "TRANSLATOR_GRAPHITE_MIST":    {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": +10},
    ...
    "PANEL_4X4":                   {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": +10},
    "PEBBLES_XL":                  {"size": 10, "min_half": 4, "inv_skew": 15, "target_pos": +10},
    "GALAXY_SOUNDS_DARK_MATTER":   {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "PANEL_2X2":                   {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": -10},
    "ROBOT_IRONING":               {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},
    # v9: target_pos=+5 (REVERSE the losing direction — ride the uptrend).
    "ROBOT_VACUUMING":             {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": +10},
    ...
    "UV_VISOR_RED":                  {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": +10},
    "UV_VISOR_ORANGE":               {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": +10},
    "UV_VISOR_YELLOW":               {"size": 10, "min_half": 2, "inv_skew": 12, "target_pos": -5},
    ...
    "GALAXY_SOUNDS_PLANETARY_RINGS": {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    # v16: tier-1 upgrade. Drift -398 was under-captured at tier-2 sizing.
    "PANEL_1X4":                     {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": -10},
    ...
    "SLEEP_POD_COTTON":              {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},
    "PEBBLES_S":                     {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "MICROCHIP_OVAL":                {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},

    # ----- v13 ADDITIONS — 4 more trending non-CFG products -----
    "UV_VISOR_MAGENTA":              {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "PANEL_2X4":                     {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "ROBOT_MOPPING":                 {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "MICROCHIP_TRIANGLE":            {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},

    # ----- v14 ADDITIONS — 6 more trending non-CFG products -----
    "TRANSLATOR_SPACE_GRAY":         {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "SLEEP_POD_LAMB_WOOL":           {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "MICROCHIP_SQUARE":              {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "OXYGEN_SHAKE_GARLIC":           {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},
    "OXYGEN_SHAKE_MINT":             {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "OXYGEN_SHAKE_MORNING_BREATH":   {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},

    # ----- v15 ADDITIONS — small-drift sweep -----
    "PEBBLES_XS":                    {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "TRANSLATOR_VOID_BLUE":          {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},
    "SLEEP_POD_NYLON":               {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},
    "MICROCHIP_CIRCLE":              {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},

    # ----- v17 ADDITIONS — final low-drift sweep -----
    "SNACKPACK_CHOCOLATE":           {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},
    "OXYGEN_SHAKE_EVENING_BREATH":   {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "SLEEP_POD_POLYESTER":           {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": +10},
    "GALAXY_SOUNDS_BLACK_HOLES":     {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},

    # ----- v18 ADDITIONS — smallest-drift sweep -----
    "PEBBLES_L":                     {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "SNACKPACK_VANILLA":             {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    "GALAXY_SOUNDS_SOLAR_WINDS":     {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos": -10},
    ...
    "ROBOT_DISHES":                  {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos":  0},
    "OXYGEN_SHAKE_CHOCOLATE":        {"size": 10, "min_half": 3, "inv_skew": 15, "target_pos":  0},
}
...
CFG["UV_VISOR_YELLOW"] = {"size": 10, "min_half": 2, "inv_skew": 15, "target_pos": -10}
